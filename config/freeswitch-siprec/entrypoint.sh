...
sed -i -e "s/sip_port=[[:digit:]]\+/sip_port=5090/g" /usr/local/freeswitch/conf/vars_diff.xml
sed -i -e "s/tls_port=[[:digit:]]\+/tls_port=5091/g" /usr/local/freeswitch/conf/vars_diff.xml
sed -i 's/internal_sip_port=5060/internal_sip_port=5090/' /usr/local/freeswitch/conf/vars.xml
